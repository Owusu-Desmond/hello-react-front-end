...
**[hello-react-front-end]** is an application to greet users. It is a front-end application that consumes the [hello-rails-back-end](https://github.com/Owusu-Desmond/hello-rails-back-end/) API.
...
`NOTE:` _You may need to run this command in the project directory to install the required packages and run the application:_
...
Feel free to check the [issues page](https://github.com/owusu-desmond/hello-react-front-end/issues).
...
I would like to say thanks to everyone who showed their support and help me to improve my skills.
